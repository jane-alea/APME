# This documents the APME binary format with `version = 6`
Changes from V5:  
- Made palette version a generic number instead of hardcoded
...
3. 1 octet: block palette version [u8]
4. 2 octets: map name octet length [u16]
5. UTF-8 encoded map name
6. 3 octets: skybox top colour
7. 3 octets: skybox middle colour
8. 3 octets: skybox bottom colour
9. 2 octets: skybox offset [i16]
10. 1 octet: whether the fog is enabled (0 is `false`, anything else is `true`)
11. 4 octets: fog near [f32]
12. 4 octets: fog far [f32]
13. 3 octets: fog colour
14. 3 octets: light colour
15. 4 octets: ambient light intensity [f32]
16. 4 octets: light intensity [f32]
17. 4 octets: sun azimuth [f32]
18. 4 octets: sun elevation [f32]
19. 8 octets: elapsed time, in milliseconds [u64]
20. 8 octets: total blocks changed [u64]
21. 4 octets: total actions [u32]
22. 2 octets: author count [u16]
23. FOR EACH AUTHOR:
    1. UTF-8 encoded author name
24. 2 octets: layer count [u16]
25. FOR EACH LAYER:
...
26. 2 octets: max history entries; if zero, then the true value is Infinity [u16]
27. 8 octets: current history entry ID [f64]
28. 4 octets: history entries [u32]
29. FOR EACH HISTORY ENTRY:
